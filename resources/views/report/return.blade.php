            ...
            <div class="table-responsive text-nowrap">
                <table class="table ">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">There is no return data</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportpdf').attr('href', '/administrator/ReportReturn/pdf/' + start.format('YYYY-MM-DD') + '+' +
            ...
            $('#created_at').daterangepicker({
                ...
                $('#exportpdf').attr('href', '/administrator/ReportReturn/pdf/' + first.format(
