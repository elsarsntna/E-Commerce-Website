                ...
                <ul class="menu-inner py-2">
                    ...
                    <li class="menu-item {{ request()->segment(2) == 'orders' ? 'active' : '' }}">
                        <a href="{{ route('orders.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx bx-clipboard"></i>
                    ...
                    <li class="menu-item {{ request()->segment(2) == 'ReportOrder' ? 'active' : '' }}">
                        <a href="{{ route('report.order') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx bx-file"></i>
                            <div data-i18n="Analytics">Order Report</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->segment(2) == 'ReportReturn' ? 'active' : '' }}">
                        <a href="{{ route('report.return') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx bx-file"></i>
                            <div data-i18n="Analytics">Return Report</div>
                        </a>
                    </li>
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text">Settings</span>
                    </li>
                    <li class="menu-item {{ request()->segment(2) == '/logoutadmin' ? 'active' : '' }}">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block">elsarsntna</span>
